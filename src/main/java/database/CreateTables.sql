...
CREATE TABLE FEATURE (
	...
	PARENT VARCHAR(500), -- NULL IN CASE IS ROOT
	FEATURE_MODEL VARCHAR(500) NOT NULL,
...
CREATE TABLE ATTRIBUTE (
	...
	TARGET_FEATURE VARCHAR(500) NOT NULL,
...
CREATE TABLE DEPENDENCY (
	ID VARCHAR(500) NOT NULL,
	TYPE VARCHAR(20) NOT NULL,
	SOURCE_FEATURE VARCHAR(500) NOT NULL,
	TARGET_FEATURE VARCHAR(500) NOT NULL,
...
CREATE TABLE PART (
	ID VARCHAR(500) NOT NULL,
	PART_TYPE VARCHAR(500) NOT NULL,
...
CREATE TABLE VARIATION_POINT (
	ID VARCHAR(500) NOT NULL,
	CODE_ELEMENT_ID VARCHAR(500) NOT NULL,
...
CREATE TABLE VARIANT_COMPONENT (
	ID VARCHAR(500) NOT NULL,
	VARIANT_MODEL VARCHAR(500) NOT NULL,
	IS_SELECTED BOOLEAN,
