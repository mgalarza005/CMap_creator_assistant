...
public class FamilyModelDB {
	...
	private static final String INSERT_CODEFILE = "INSERT INTO CODEFILE (ID,FILENAME, CONTENT) VALUES (:id,:filename,:content);";
	...
	private static void createCodeElementsInsertsRecursive(CodeElement ce) {
		...
		if(ce instanceof CodeFile) {
			...
			s = INSERT_CODEFILE
					...
					.replace(":content", MainSql.str((cf.getContent())));
